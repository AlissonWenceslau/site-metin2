  ...
  <main>
    <div class="toast-container position-fixed top-0 end-0 p-3" style="z-index: 1100;">
      <?php if (isset($_SESSION['sucesso_sistema'])): ?>
        <div id="toastSucesso" class="toast align-items-center text-white bg-success border-0 shadow" role="alert"
      ...
      <?php if (isset($_SESSION['erro_sistema'])): ?>
        <div id="toastErro" class="toast align-items-center text-white bg-danger border-0 shadow" role="alert"
      ...
      <div class="container">
        ...
        <div class="container mt-5 mb-2">
          <div class="d-flex align-items-center justify-content-center mb-4">
            ...
            <h2 class="px-3 text-uppercase fw-bold text-center tracking-wide text text-primary"
          ...
          <div class="row justify-content-center g-4">
            <?php if (!empty($noticias)): ?>
              <?php foreach ($noticias as $index => $item): ?>
                        ...
                        <div>
                          <?php if ($index === 0): ?>
                            <span class="badge bg-danger text-uppercase mb-2"
                              style="font-size: 0.75rem; letter-spacing: 1px; animation: pulse 2s infinite;">🔥NOVIDADE</span>
                          <?php else: ?>
                ...
                <div class="modal fade" id="modalNoticia<?= $item['id']; ?>" tabindex="-1"
                        ...
                        <div>
                          ...
                          <p class="text-white-50 small mb-0" style="font-size: 0.85rem;">
                            Publicado por <strong
                              class="text-white fw-semibold"><?= htmlspecialchars($item['autor']); ?></strong> em
                            <?= date('d/m/Y \à\s H:i', strtotime($item['data_publicacao'])); ?>
                          </p>
                        </div>
              ...
              <div class="d-grid gap-2 mt-4 mb-4">
                <a href="./pages/news.php" class="btn btn-outline-primary py-2 fw-semibold text-uppercase"
                ...
                <nav aria-label="Navegação de páginas" class="mt-4">
                  <ul class="pagination justify-content-center">
                    <li class="page-item <?= $paginaAtual <= 1 ? 'disabled' : ''; ?>">
                      <a class="page-link bg-dark border-secondary text-light" href="?pagina=<?= $paginaAtual - 1; ?>"
                        aria-label="Anterior">
