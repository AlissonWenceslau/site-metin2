    ...
    <div class="w-75">
      <form class="needs-validation" method="post" action="./register.php" novalidate>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" minlength="5" maxlength="12" placeholder="Mínimo 5 e Máximo 12 caracteres" pattern="[a-zA-Z0-9]+" aria-label="default input example" id="username" name="username" required>
