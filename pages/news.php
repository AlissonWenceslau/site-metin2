  ...
  <main class="container mt-5 mb-5">
    <div class="row justify-content-center">
        <div class="col-12 col-md-10 col-lg-8">
            <h2 class="h3 mb-4 text-primary text-uppercase fw-bold"><i class="bi bi-newspaper text-primary me-2"></i>Mural de Notícias</h2>
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <?php if ($isUltimaNoticia): ?>
                                        <span class="badge bg-danger text-uppercase mb-2" style="font-size: 0.75rem; letter-spacing: 1px;">🔥 NOVIDADE</span>
                                    <?php else: ?>
                            ...
                            <?php if (isset($_SESSION['web']) && $_SESSION['web'] == 1): ?>
                                <div class="text-end mt-3 border-top border-secondary pt-2 d-flex justify-content-end gap-2">
                                    <a href="/pages/adm/news/edit_new.php?id=<?= $item['id']; ?>" class="btn btn-outline-warning btn-sm p-1 px-2 fw-semibold" style="font-size: 0.8rem;" onclick="event.stopPropagation();">
                                        <i class="bi bi-pencil me-1"></i> Editar
                                    </a>
                                    <a href="excluir_noticia.php?id=<?= $item['id']; ?>" class="btn btn-outline-danger btn-sm p-1 px-2 fw-semibold" style="font-size: 0.8rem;" onclick="event.stopPropagation(); return confirm('⚠️ Tem certeza que deseja excluir esta notícia?\n\nEsta ação não poderá ser desfeita!');">
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content bg-dark text-light border-secondary">
                            ...
                            <div class="modal-header border-secondary d-flex align-items-start justify-content-between">
                                <div>
                                    <!-- Título Dinâmico -->
                                    <h5 class="modal-title text-warning fw-bold text-uppercase mb-1" id="modalNoticiaLabel<?= $item['id']; ?>">
                                        <?= htmlspecialchars($item['titulo']); ?>
                                    </h5>
                    ...
                    <nav aria-label="Navegação de páginas" class="mt-4">
                        <ul class="pagination justify-content-center">
                            ...
                            <li class="page-item <?= $paginaAtual <= 1 ? 'disabled' : ''; ?>">
                                <a class="page-value page-link bg-dark border-secondary text-light" href="?pagina=<?= $paginaAtual - 1; ?>" aria-label="Anterior">
                            ...
                            <li class="page-item <?= $paginaAtual >= $totalPaginas ? 'disabled' : ''; ?>">
                                <a class="page-value page-link bg-dark border-secondary text-light" href="?pagina=<?= $paginaAtual + 1; ?>" aria-label="Próximo">
