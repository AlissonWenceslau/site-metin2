              ...
              <form class="needs-validation" method="post" action="/pages/validation/validate_register.php" novalidate>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group has-validation">
                    <input type="text"
                      class="form-control bg-secondary bg-opacity-10 text-white border-secondary custom-placeholder"
                      maxlength="12" id="username" name="username" placeholder="Digite seu usuário" required>
                    <button type="button"
                      class="btn btn-outline-secondary border-secondary bg-secondary bg-opacity-10 text-secondary-light"
                      data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true"
                      data-bs-title="Requisitos do Login"
                      data-bs-content="• Mínimo: 8 caracteres<br>• Máximo: 12 caracteres">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group has-validation">
                    <input type="email"
                      class="form-control bg-secondary bg-opacity-10 text-white border-secondary custom-placeholder"
                      maxlength="50" id="email" name="email" placeholder="guerreiro@exemplo.com"
                      data-bs-toggle="tooltip" data-bs-placement="top" title="email@example.com" required>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group has-validation">
                    ...
                    <button type="button"
                      class="btn btn-outline-secondary border-secondary bg-secondary bg-opacity-10 text-secondary-light"
                      data-bs-container="body" data-bs-title="Requisitos da Senha" data-bs-toggle="popover"
                      data-bs-placement="top" data-bs-html="true"
                      data-bs-content="• Mínimo 8 e máximo 12 caracteres<br>• 1 letra maiúscula<br>• 1 letra minúscula<br>• 1 caractere especial<br>• 1 número">
                      <i class="bi bi-question-circle"></i>
                    </button>
                    <div class="invalid-feedback">Campo obrigatório!</div>
                  </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group has-validation">
                    <input type="password" maxlength="12"
                      class="form-control bg-secondary bg-opacity-10 text-white border-secondary custom-placeholder"
                      id="password-confirm" name="password-confirm" placeholder="Repita a senha" required>
                    <div class="invalid-feedback">Campo obrigatório!</div>
                  </div>
                </div>

                <div class="mb-4">
                  <label for="password-character"
                    class="form-label fw-semibold text-secondary-light small text-uppercase">
                  ...
                  <div class="input-group has-validation">
                    <input
                      class="form-control bg-secondary bg-opacity-10 text-white border-secondary custom-placeholder"
                      maxlength="7" type="number" value="1234567" id="password-character" name="character" required>
                    <button type="button"
                      class="btn btn-outline-secondary border-secondary bg-secondary bg-opacity-10 text-secondary-light"
                      data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true"
                      data-bs-title="Código de Deleção"
                      data-bs-content="• Deve conter exatamente 7 dígitos numéricos.<br>• Usado para apagar personagens dentro do jogo.">
                      <i class="bi bi-question-circle"></i>
                    </button>
                    <div class="invalid-feedback">Campo obrigatório!</div>
                  </div>
                ...
                <div class="form-check mb-4">
                  <input class="form-check-input bg-secondary bg-opacity-10 border-secondary" type="checkbox" value=""
                    id="flexCheckDefault" style="cursor: pointer;">
                  <label class="form-check-label text-secondary-light small user-select-none" for="flexCheckDefault"
                    style="cursor: pointer;">
                    Estou ciente e aceito os <a href="rules.php" target="_blank"
                      class="text-primary fw-semibold link-underline-opacity-25">termos de uso</a>
                    do servidor.
                  </label>
                </div>

                <button type="submit"
                  class="btn btn-primary btn-lg w-100 fw-bold text-uppercase signup-btn d-flex align-items-center justify-content-center gap-2"
                  disabled id="submit" style="letter-spacing: 0.5px;">
