        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8">
            ...
            <div class="text-center mb-5">
                ...
                <p class="text-white-50 small">Acompanhe em tempo real a integridade e disponibilidade dos serviços do jogo.</p>
            </div>
                    ...
                    <div class="card bg-dark text-light border-secondary h-100 shadow-sm transition-hover">
                        <div class="card-body p-4 d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <div class="bg-secondary bg-opacity-10 p-3 rounded border border-secondary me-3 text-primary fs-4">
                                    <i class="bi bi-shield-lock-fill"></i>
                                </div>
                                <div>
                                    <h4 class="h6 mb-1 text-white text-uppercase fw-bold" style="letter-spacing: 0.5px;">Serviço de Login</h4>
                            ...
                            <div class="text-end">
                                <?php if ($conn): ?>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="badge bg-success bg-opacity-25 border border-success text-success px-3 py-2 fw-bold" style="font-size: 0.8rem;">ONLINE</span>
                                    </div>
                                <?php else: ?>
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="status-pulse bg-danger animate-none"></span>
                                        <span class="badge bg-danger bg-opacity-25 border border-danger text-danger px-3 py-2 fw-bold" style="font-size: 0.8rem;">OFFLINE</span>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="card bg-dark text-light border-secondary h-100 shadow-sm transition-hover">
                        <div class="card-body p-4 d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="h6 mb-1 text-white text-uppercase fw-bold" style="letter-spacing: 0.5px;">Servidor - CH 1</h4>
